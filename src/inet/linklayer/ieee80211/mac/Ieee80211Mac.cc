...
void Ieee80211Mac::initialize(int stage)
{
    ...
    if (stage == INITSTAGE_LOCAL) {
        ...
        cModule *radioModule = gate("lowerLayerOut")->getNextGate()->getOwnerModule(); //get radio module @myd
        radioModule->subscribe(IRadio::radioModeChangedSignal, this);
        radioModule->subscribe(IRadio::receptionStateChangedSignal, this);
        radioModule->subscribe(IRadio::transmissionStateChangedSignal, this);
        radioModule->subscribe(IRadio::receivedSignalPartChangedSignal, this);
        radio = check_and_cast<IRadio *>(radioModule); // ptr @myd
        rx = check_and_cast<IRx *>(getSubmodule("rx")); // the submodule of Ieee80211Mac.ned @myd
...
void Ieee80211Mac::handleUpperPacket(cPacket *msg)
{
    ...
    //EV_INFO << "We get to the handleUpperPacket() function now!" << endl;
}
...
void Ieee80211Mac::receiveSignal(cComponent *source, simsignal_t signalID, intval_t value, cObject *details) // signal not data @myd
{
